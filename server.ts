...
// Comparison Papers endpoint - Strict 3 Paper Models (Paper 1, Paper 2, Paper 3)
app.get('/api/comparison/papers', (req: Request, res: Response) => {
  res.json([
    {
      id: 'paper1_joint_cnn',
      code: 'M3',
      title: 'Joint CNN encryption and steganography using KeyMixer with Encoder-Decoder',
      authors: 'Iqbal et al.',
      year: 2026,
      venue: 'Scientific Reports (Nature)',
      doi: '10.1038/s41598-026-8228',
      methodology: 'Encoder-Decoder CNN with spatial KeyMixer cross-channel attention module',
      typicalPsnr: 38.4,
      maxBpp: 0.40,
      stegResistance: 'Moderate (24.0% detection rate under SRM/Xu-Net)',
      robustnessAgainstJpg: 'Medium',
      parameterCount: '1.82M (7.3 MB)',
      computationalCost: '4.60 GFLOPs',
      checkpointStatus: 'Missing (Unpublished Proprietary Weights)',
      status: 'Literature Baseline',
    },
    {
      id: 'paper2_cyclegan_steg',
      code: 'M4',
      title: 'Three-player game cycle-consistent generative adversarial network for steganography',
      authors: 'Abdollahi et al.',
      year: 2023,
      venue: 'Journal of Information Security and Applications (Elsevier)',
      doi: '10.1016/j.jisa.2023.103631',
      methodology: 'Three-player CycleGAN (Generator G, Extractor F, Steganalyzer D, Hiding Net H)',
      typicalPsnr: 36.2,
      maxBpp: 0.35,
      stegResistance: 'Moderate (31.0% detection rate under Ye-Net/Xu-Net)',
      robustnessAgainstJpg: 'Low',
      parameterCount: '11.4M (45.6 MB)',
      computationalCost: '28.40 GFLOPs',
      checkpointStatus: 'Missing (Unpublished Proprietary Weights)',
      status: 'Literature Baseline',
    },
    {
      ...
      code: 'M5',
      title: 'Preparation/Hiding/Reveal block-based CNN steganography',
      authors: 'Dabhade et al.',
      year: 2026,
      venue: 'Multimedia Tools and Applications (Springer)',
      doi: '10.1007/s11042-026-482',
      methodology: 'Block preparation network + spatial hiding CNN + reveal CNN with 8x8 block tokenization',
      typicalPsnr: 39.8,
      maxBpp: 0.45,
      stegResistance: 'High (19.0% detection rate under SRM/Xu-Net)',
      robustnessAgainstJpg: 'Medium',
      parameterCount: '2.45M (9.8 MB)',
      computationalCost: '6.20 GFLOPs',
      checkpointStatus: 'Missing (Unpublished Proprietary Weights)',
      status: 'Literature Baseline',
    },
  ]);
